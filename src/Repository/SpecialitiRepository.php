 ...
 */
class SpecialitiRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return Specialiti[] Returns an array of Specialiti objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Specialiti
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.exampleField = :val')
            ->setParameter('val', $value)
